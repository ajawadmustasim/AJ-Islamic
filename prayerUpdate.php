...
<body>
    <h1>Update Prayer Record</h1>
    <form action="PrayerUpdated.php" method="post">
        <table>

            <tr>
                <th><label for="">Date : </label></th>
                <th><input type="date" name="prayer_date" id="prayer_date" value=<?php  if(isset($_GET['prayer_date'])) echo $_GET['prayer_date']; ?>> </th>
            </tr>
            ...
            <tr>
                <td><a href='PrayerviewAll.php' target='_parent'></a><button>Go back</button></a></td>
                <td><input type='submit' value='Update' name='btnUpdate' class="btnUpdate"></td>
            </tr>
